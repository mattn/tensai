...
type Loss interface {
	...
	Loss(pred, target *tensai.Matrix) (tensai.Float, *tensai.Matrix, error)
...
func (MeanSquaredError) Loss(pred, target *tensai.Matrix) (tensai.Float, *tensai.Matrix, error) {
	grad := tensai.NewMatrix(pred.Rows, pred.Cols)
...
func (MeanSquaredError) LossInto(pred, target, grad *tensai.Matrix) (tensai.Float, error) {
...
func (SoftmaxCrossEntropy) Loss(pred, target *tensai.Matrix) (tensai.Float, *tensai.Matrix, error) {
	grad := tensai.NewMatrix(pred.Rows, pred.Cols)
...
func (SoftmaxCrossEntropy) LossInto(pred, target, grad *tensai.Matrix) (tensai.Float, error) {
	...
	var loss tensai.Float
	invRows := 1 / tensai.Float(pred.Rows)
...
func (BinaryCrossEntropy) Loss(pred, target *tensai.Matrix) (tensai.Float, *tensai.Matrix, error) {
	grad := tensai.NewMatrix(pred.Rows, pred.Cols)
...
func (BinaryCrossEntropy) LossInto(pred, target, grad *tensai.Matrix) (tensai.Float, error) {
	if err := checkShapes(pred, target); err != nil {
		return 0, err
	}
	if err := checkShapes(pred, grad); err != nil {
...
func checkShapes(a, b *tensai.Matrix) error {
	if a == nil || b == nil {
